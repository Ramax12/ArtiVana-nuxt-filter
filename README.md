...
| Файл | Описание |
|------|----------|
| `src/filter/dto/create-filter.dto.ts` | DTO-классы для валидации и типизации входящих параметров фильтра (категории, диапазон цен, сортировка и т.д.) |
| `src/filter/dto/filter-meta.dto.ts` | DTO-классы для валидации и типизации исходящих параметров фильтра (категории, диапазон цен, сортировка и т.д.) |
